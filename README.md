# [Spring Cloud Ribbon Extensions v1.4.4](https://github.com/enadim/spring-cloud-ribbon-extensions/wiki) :rocket::microscope:
...
[![Maven Central](https://img.shields.io/maven-central/v/com.github.enadim/spring-cloud-ribbon-extensions.svg)](http://search.maven.org/#artifactdetails|com.github.enadim|spring-cloud-ribbon-extensions|1.4.4)
[![Javadocs](http://www.javadoc.io/badge/com.github.enadim/spring-cloud-ribbon-extensions/1.4.4.svg)](http://www.javadoc.io/doc/com.github.enadim/spring-cloud-ribbon-extensions/1.4.4)
...
```gradle
dependencies {
    compile 'com.github.enadim:spring-cloud-ribbon-extensions:1.4.4'
}
```
