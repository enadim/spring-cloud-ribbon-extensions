...
public class SchedulingTaskExecutorPropagatorTest extends AbstractExecutorPropagatorTest {
    private final SchedulingTaskExecutor delegate = mock(SchedulingTaskExecutor.class);
    private final SchedulingTaskExecutorPropagator propagator = new SchedulingTaskExecutorPropagator(delegate);
