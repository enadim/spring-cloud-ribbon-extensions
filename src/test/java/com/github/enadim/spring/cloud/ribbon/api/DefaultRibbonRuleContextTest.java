...
public class DefaultRibbonRuleContextTest {
    final DefaultRibbonRuleContext context = new DefaultRibbonRuleContext();
    ...
    public void testConcurrency() throws Exception {
        ...
        for (int i = 0; i < concurrent; i++) {
            futures.add(executorService.submit(() -> {
                List<String> shuffles = new ArrayList<>(context.getAttributes().keySet());
