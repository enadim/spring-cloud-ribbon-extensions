...
public class HeadersCopyStompSessionAdapterTest {
    ...
    private HeadersCopyStompSessionAdapter propagator = new HeadersCopyStompSessionAdapter(delegate, keysToCopy::contains);
    ...
    public void testSubscribe() throws Exception {
        ...
        verify(delegate).subscribe(eq(destination), any(HeadersCopyStompFrameHandlerAdapter.class));
    }

    @Test
    public void testSubscribeWithStompHeaders() throws Exception {
        propagator.subscribe(headers, handler);
        verify(delegate).subscribe(eq(headers), any(HeadersCopyStompFrameHandlerAdapter.class));
    }
