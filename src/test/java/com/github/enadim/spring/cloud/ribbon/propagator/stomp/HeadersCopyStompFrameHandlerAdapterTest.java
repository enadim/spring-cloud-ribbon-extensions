...
public class HeadersCopyStompFrameHandlerAdapterTest {
    ...
    private HeadersCopyStompFrameHandlerAdapter propagator = new HeadersCopyStompFrameHandlerAdapter(delegate, attributes::contains);
