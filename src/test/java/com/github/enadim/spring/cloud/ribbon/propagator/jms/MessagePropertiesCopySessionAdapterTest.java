...
public class MessagePropertiesCopySessionAdapterTest {
    Set<String> keys = new HashSet<>(asList("1"));
    Session delegate = mock(Session.class);
    MessagePropertiesCopySessionAdapter propagator = new MessagePropertiesCopySessionAdapter(delegate, keys::contains);
    ...
    public void setMessageListener() throws Exception {
        ...
        reset(delegate);
        propagator.setMessageListener(new MessagePropertiesCopyMessageListener(mock(MessageListener.class), null));
        verify(delegate).setMessageListener(any(MessagePropertiesCopyMessageListener.class));
    }
