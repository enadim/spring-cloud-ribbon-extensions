...
public class HystrixPropagationStrategyTest {
    HystrixConcurrencyStrategy delegate = mock(HystrixConcurrencyStrategy.class);
    HystrixPropagationStrategy strategy = new HystrixPropagationStrategy(delegate);
    ...
    public void wrapCallable() throws Exception {
        MatcherAssert.assertThat(strategy.wrapCallable(null).getClass(), Matchers.equalTo(PropagationCallable.class));
    }
}