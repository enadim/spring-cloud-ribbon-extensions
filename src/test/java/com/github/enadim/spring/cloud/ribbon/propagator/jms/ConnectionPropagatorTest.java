...
public class ConnectionPropagatorTest {
    Connection delegate = mock(Connection.class);
    ConnectionPropagator propagator = new ConnectionPropagator(delegate, null);

    @Test
    public void createSession() throws Exception {
        assertThat(propagator.createSession(true, 1).getClass(), equalTo(SessionPropagator.class));
