...
public class ExecutionContextAwareRunnable implements Runnable {
     ...
     */
    public ExecutionContextAwareRunnable(Runnable delegate) {
    ...
    /**
     * Wraps a Runnable to a {@link ExecutionContextAwareRunnable}
     *
     * @param runnable the runnable to wrap
     * @return the instance of {@link ExecutionContextAwareRunnable} over the runnable
     */
    public static Runnable wrap(Runnable runnable) {
        return new ExecutionContextAwareRunnable(runnable);
    }
}
