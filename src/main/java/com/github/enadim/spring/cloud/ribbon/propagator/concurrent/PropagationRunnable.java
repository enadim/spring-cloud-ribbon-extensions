...
public class PropagationRunnable implements Runnable {
    ...
    /**
     * Sole constructor: saves the current {@link RibbonRuleContext} for later {@link #run()} invocation.
     *
     * @param delegate the delegate {@link Runnable}
     */
    public PropagationRunnable(Runnable delegate) {
