 ...
 */
public class ExecutionContextAwareExecutor implements Executor, TaskExecutor {
    /**
     ...
     */
    public ExecutionContextAwareExecutor(@NotNull Executor delegate) {
    ...
    public final void execute(Runnable command) {
        delegate.execute(ExecutionContextAwareRunnable.wrap(command));
    }
}
