...
public class DynamicAttributeMatcherConfig extends RuleBaseConfig {
     ...
     * @return an instance of {@link DynamicAttributeMatcher}
     */
    @Bean
    public DynamicAttributeMatcher strictMetadataMatcher(IClientConfig clientConfig) {
        log.info("Enabled for client [{}] on dynamic key[{}].", clientConfig.getClientName(), dynamicAttributeKey);
        return new DynamicAttributeMatcher(dynamicAttributeKey);
    }
}
