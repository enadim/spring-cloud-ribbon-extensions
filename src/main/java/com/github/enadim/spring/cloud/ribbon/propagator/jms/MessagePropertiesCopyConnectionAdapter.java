...
/**
 * Connection adapter that preserves the {@link ExecutionContext} by copying message properties from/to the current {@link ExecutionContext} entry pre-filtering property names or entry keys using the provided {@link #filter}.
 *
 * @author Nadim Benabdenbi
 */
public class MessagePropertiesCopyConnectionAdapter implements Connection {
    /**
     ...
     */
    public MessagePropertiesCopyConnectionAdapter(Connection delegate, Filter<String> filter) {
    ...
    public Session createSession(boolean transacted, int acknowledgeMode) throws JMSException {
        return new MessagePropertiesCopySessionAdapter(delegate.createSession(transacted, acknowledgeMode), filter);
    }
