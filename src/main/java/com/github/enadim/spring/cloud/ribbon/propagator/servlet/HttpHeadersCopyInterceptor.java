...
@Component
@Slf4j
public class HttpHeadersCopyInterceptor implements HandlerInterceptor {
    /**
     ...
     */
    public HttpHeadersCopyInterceptor(@NotNull Filter<String> filter) {
        this.filter = filter;
    }
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        try {
            ...
            log.warn("Failed to copy http request header to the execution context.", e.getMessage());
        }
        return true;
    }
