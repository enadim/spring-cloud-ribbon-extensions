 ...
 */
public class ExecutionContextAwareThreadPoolTaskScheduler extends ExecutionContextAwareThreadPoolTaskExecutor implements TaskScheduler {
    /**
     * The delegate task scheduler propagator.
     */
    private final ExecutionContextAwareTaskScheduler executionContextAwareTaskScheduler;
     ...
     */
    public ExecutionContextAwareThreadPoolTaskScheduler(@NotNull AsyncListenableTaskExecutor asyncListenableTaskExecutor,
                                                        @NotNull SchedulingTaskExecutor schedulingTaskExecutor,
                                                        @NotNull TaskScheduler taskScheduler) {
        super(asyncListenableTaskExecutor, schedulingTaskExecutor);
        executionContextAwareTaskScheduler = new ExecutionContextAwareTaskScheduler(taskScheduler);
    }
